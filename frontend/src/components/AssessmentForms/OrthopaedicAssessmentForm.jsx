...
export const defaultOrthopaedicAssessment = {
  patientName: '',
  patientAge: '',
  patientGender: '',
  patientAddress: '',
...
function OrthopaedicAssessmentForm({ value, onChange }) {
  const assessment = { ...defaultOrthopaedicAssessment, ...(value || {}) };
  ...
  return (
    <div className="assessment-block">
      <div className="section-title">
        <h3>Orthopaedic Physiotherapy Assessment</h3>
      </div>
      ...
      <h4 className="assessment-heading">Pain Assessment</h4>
      <div className="assessment-grid">
        <div className="form-group">
          <label>Site</label>
          <input
      ...
      <h4 className="assessment-heading">Palpation</h4>
      <div className="assessment-grid">
        <div className="form-group">
          <label>Tenderness</label>
          <input
            type="text"
            value={assessment.palpationTenderness}
            onChange={(e) => handleChange('palpationTenderness', e.target.value)}
          />
        </div>
        <div className="form-group">
          <label>Tone</label>
          <input
            type="text"
            value={assessment.palpationTone}
            onChange={(e) => handleChange('palpationTone', e.target.value)}
          />
        </div>
        <div className="form-group">
          ...
          <input
            type="text"
            value={assessment.palpationTemperature}
            onChange={(e) => handleChange('palpationTemperature', e.target.value)}
          />
        </div>
        <div className="form-group">
          <label>Swelling / spasm</label>
          <input
            type="text"
            value={assessment.palpationSwelling}
            onChange={(e) => handleChange('palpationSwelling', e.target.value)}
          />
        </div>
      </div>
      ...
      <div className="form-group">
        <label>Orthopaedic tests</label>
        <textarea
          rows={2}
          value={assessment.specialOrthopaedicTests}
          onChange={(e) => handleChange('specialOrthopaedicTests', e.target.value)}
        />
      </div>
      ...
      <div className="form-group">
        <label>Outcome Measures (VAS / NDI / ODI)</label>
        <input
          type="text"
...
export default OrthopaedicAssessmentForm;
