...
export const defaultNeurologicalAssessment = {
  patientName: '',
  patientAge: '',
  patientGender: '',
  patientAddress: '',
...
function NeurologicalAssessmentForm({ value, onChange }) {
  const assessment = { ...defaultNeurologicalAssessment, ...(value || {}) };
  ...
  return (
    <div className="assessment-block">
      <div className="section-title">
        <h3>Neurological Physiotherapy Assessment</h3>
      </div>
      ...
      <h4 className="assessment-heading">Pain Assessment (If Applicable)</h4>
      <div className="assessment-grid">
        <div className="form-group">
          <label>Site</label>
          <input
            type="text"
            value={assessment.painSite}
            onChange={(e) => handleChange('painSite', e.target.value)}
          />
        </div>
        <div className="form-group">
          <label>Type</label>
        ...
        <div className="form-group">
          <label>Intensity (VAS / NRS)</label>
          <input
            type="text"
            value={assessment.painIntensity}
        ...
        <div className="form-group">
          ...
          <input
            ...
            onChange={(e) => handleChange('painRadiation', e.target.value)}
          />
        </div>
      </div>
      ...
      <h4 className="assessment-heading">Neurological Examination</h4>
      <div className="assessment-grid">
        <div className="form-group">
          <label>Mental status</label>
          <input
            type="text"
            value={assessment.neuroMentalStatus}
            onChange={(e) => handleChange('neuroMentalStatus', e.target.value)}
          />
        </div>
        <div className="form-group">
          ...
          <input
            type="text"
            value={assessment.neuroCranialNerves}
            onChange={(e) => handleChange('neuroCranialNerves', e.target.value)}
          />
        </div>
        <div className="form-group">
          <label>Muscle tone (MAS)</label>
          <input
            type="text"
            value={assessment.neuroMuscleTone}
            onChange={(e) => handleChange('neuroMuscleTone', e.target.value)}
          />
        </div>
        <div className="form-group">
          ...
          <input
            type="text"
            value={assessment.neuroReflexes}
            onChange={(e) => handleChange('neuroReflexes', e.target.value)}
          />
        </div>
        <div className="form-group">
          ...
          <input
            type="text"
            value={assessment.neuroSensory}
            onChange={(e) => handleChange('neuroSensory', e.target.value)}
          />
        </div>
        <div className="form-group">
          ...
          <input
            type="text"
            value={assessment.neuroCoordination}
            onChange={(e) => handleChange('neuroCoordination', e.target.value)}
          />
        </div>
        <div className="form-group">
          <label>Balance</label>
          <input
            type="text"
            value={assessment.neuroBalance}
            onChange={(e) => handleChange('neuroBalance', e.target.value)}
          />
        </div>
      </div>
      ...
      <div className="form-group">
        <label>Neurological tests</label>
        <textarea
          rows={2}
          value={assessment.specialNeurologicalTests}
          onChange={(e) => handleChange('specialNeurologicalTests', e.target.value)}
        />
      </div>
      ...
      <div className="assessment-grid">
        ...
        <div className="form-group">
          ...
          <input
            type="text"
            value={assessment.functionalGait}
            onChange={(e) => handleChange('functionalGait', e.target.value)}
          />
        </div>
      </div>
      ...
      <div className="assessment-grid">
        ...
        <div className="form-group">
          <label>Neuro facilitation</label>
          <input
            type="text"
            value={assessment.treatmentNeuroFacilitation}
            onChange={(e) => handleChange('treatmentNeuroFacilitation', e.target.value)}
          />
        </div>
        <div className="form-group">
      ...
      <div className="form-group">
        <label>Outcome Measures (FIM / Barthel Index)</label>
        <input
          type="text"
